          ...
          <div className="grid md:grid-cols-1 gap-8 max-w-2xl mx-auto">
            ...
            {/* <Card className="hover:shadow-xl transition-all duration-300 hover:scale-105 border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="text-base">
                  Secure login for police officers to manage verification requests
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/login">
                  <Button variant="outline" className="w-full py-3 text-lg font-semibold border-2 border-gray-300 hover:border-blue-500 hover:bg-blue-50">
                    Police Login
                  </Button>
                </Link>
              </CardContent>
